...
def get_optimizer(lr, optimizer='momentum'):
    if optimizer == 'sgd':
        #optimizer = npu_tf_optimizer(tf.train.GradientDescentOptimizer(lr))
        optimizer = tf.train.GradientDescentOptimizer(lr)
    elif optimizer == 'momentum':
        #optimizer = npu_tf_optimizer(tf.train.MomentumOptimizer(lr, 0.9))
        optimizer = tf.train.MomentumOptimizer(lr, 0.9)
    elif optimizer == 'adam':
        #optimizer = npu_tf_optimizer(tf.train.AdamOptimizer(lr))
