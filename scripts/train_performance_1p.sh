...
do
    ...
    nohup taskset -c $a-$c python3 train.py --gpu 0 \
      --batch_size 16 \
...
grep "loss" $cur_path/output/$ASCEND_DEVICE_ID/train_$ASCEND_DEVICE_ID.log|awk  '{print ($14+$16)}' > $cur_path/output/$ASCEND_DEVICE_ID/train_${CaseName}_loss.txt
