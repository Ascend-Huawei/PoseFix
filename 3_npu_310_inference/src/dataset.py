...
class Dataset(object):
    ...
    input_pose_path = osp.join('..', 'data', 'person_keypoints_256x192_resnet50_val2017_results.json') # set directory of the input pose
    ...
    val_annot_path = osp.join('..', 'data',  'person_keypoints_val2017.json')
    ...
    def imgid_to_imgname(self, annot, imgid, db_set):
        ...
        imgname = ["../data/" + db_set + '2017/' + i['file_name'] for i in imgs]
        return imgname
